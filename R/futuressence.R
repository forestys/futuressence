...
futuressence <- function(shape = NULL, enreg = F, rep_travail = NULL, rep_projet = NULL, rep_data = NULL, classearbremin = 20, classearbremax = 80, mappoint = FALSE,
                         tailleBuffer = NULL, essence = c("02", "09"), latitude = NULL, longitude = NULL, zonecalc = NULL, houppier = "N", clause = NULL) {
  ...
  shape <- st_read("/home/pascal/Documents/forestys/data/groupe.shp")
  # ajoute un buffer de 10m
  shape <- shape %>% st_buffer(100)
